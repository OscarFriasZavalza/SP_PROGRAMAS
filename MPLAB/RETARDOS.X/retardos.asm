;**************** THE WELS THEORY ******************
;Descripci?n: El LED conectado al PORTB-RB7 se enciende
...
;Variables
CBLOCK   0X0C       ;RAM USUARIOS ALAMACENAMOS
		    ;UN BLOQUE DE MEMORIAS PARA LAS VARIABLES A PARTIR DE 0C0C
ENDC      
...
START
    BSF	    PORTB,7;PRENDEMOS LED
    CALL    RETARDO_200ms
    CALL    RETARDO_100ms
    BCF	    PORTB,7;APAGAMOS LED
    CALL    RETARDO_200ms
    CALL    RETARDO_200ms
    GOTO    START
...
Regresa_Cuenta
    ...
    DECFSZ  Contador,F		
    GOTO    Regresa_Cuenta
    ;hasta aqui es el retardo de 1 milisegundo o us
    DECFSZ  Contador_2,F		
