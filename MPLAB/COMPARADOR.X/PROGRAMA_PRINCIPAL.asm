;**************** THE WELS THEORY ******************
;Descripci?n: Se compara un Numero con el puerto A
...
START
    ...
    MOVLW   B'11110000'; PORTA < Numero ;ESTE VALOR SE CONSERVA SI NO SE CUMPLEN LAS CONDICIONES DE ABAJO
    BTFSC   STATUS,C ;COMPROBAMOS QUE ES POSITIVO 
    MOVLW   B'01010101'; PORTA > Numero ESTO PASA SI ES POSITIVO
    BTFSC   STATUS,Z  ;COMPROBAMOS SI ES IGUAL
