;**************** THE WELS THEORY ******************
;Descripci?n: La bomba! Te muestra un mensaje por 2s
;donde tienes que desactivar una bomba dependiendo
;la combinaci?n de pulsadores.
; 
...
;Variables
CBLOCK  0x0C			; Variable que se visualizar?
ENDC
...
ENTRADA_3
    ...
    INCLUDE  <C:\SP_PROGRAMAS_UNIDAD4\Assembler-Pic16F84A\Librerias\RETARDOS.INC>
    INCLUDE  <C:\SP_PROGRAMAS_UNIDAD4\Assembler-Pic16F84A\Librerias\LCD.INC>
    END
